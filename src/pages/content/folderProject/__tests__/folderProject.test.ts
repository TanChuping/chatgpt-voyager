...
// ============================================================================
// startFolderProject 鈥?feature-off skip
// ============================================================================

describe('startFolderProject 鈥?feature disabled', () => {
  beforeEach(() => {
...
// ============================================================================
// waitForElement 鈥?model selector target
// ============================================================================

describe('waitForElement 鈥?model selector', () => {
  beforeEach(() => {
    vi.useFakeTimers();
  });
...
// ============================================================================
// startFolderProject 鈥?runtime toggle
// ============================================================================

describe('startFolderProject 鈥?runtime toggle', () => {
  ...
  it('does not initialize when toggled on in non-sync area', async () => {
    ...
    // Simulate toggle in 'local' area (not 'sync') 鈥?should be ignored
