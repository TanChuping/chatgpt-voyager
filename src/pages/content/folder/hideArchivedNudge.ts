...
type MountArgs = {
  ...
  onEnable: () => void;
  onDismiss: () => void;
  /** Extra classes for platform-scoped styling (e.g. `gv-hide-archived-nudge--legacy`). */
  variantClass?: string;
  /** Override i18n keys 鈥?defaults to the ChatGPT copy. legacy passes its own keys. */
